"""
Project 3 - Grocery Store Inventory
--------------------------------
Build an inventory application for a grocery store.
Must be able to: "View a single product's inventory", "Add a new product to the database",
“View an analysis”, and "Make a backup of the entire inventory"
